...
@Component({
  selector: 'app-jqwgrid',
  templateUrl: './jqwgrid.component.html',
  styleUrls: ['./jqwgrid.component.less']
})
export class JqwgridComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
  }
@ViewChild('jqGrid', { static: false }) myGrid: jqxGridComponent;
  source: any =
  {
